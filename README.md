...
```
gff/ _All predicted miRNAs._
filtered_gff/ _High confidence predictions after bitscore filtering._
fasta/ _Both high and low confidence predictions in FASTA format._
```
